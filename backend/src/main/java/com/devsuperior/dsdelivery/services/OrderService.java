...
import com.devsuperior.dsdelivery.respositories.OrderRepository;
import com.devsuperior.dsdelivery.respositories.ProductRepository;
...
public class OrderService {
	...
	public OrderDTO insert(OrderDTO dto) {
		...
		Order order = new Order(null, dto.getAddress(), dto.getLatitude(), null, Instant.now(), OrderStatus.PENDING);
